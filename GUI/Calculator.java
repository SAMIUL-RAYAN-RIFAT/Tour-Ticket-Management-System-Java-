...
public class Calculator extends JFrame implements ActionListener{
	...
	public Calculator(){
		...
		//JLabel
		JLabel label = new JLabel(); //a label or text on the container panel
	...
	public void actionPerformed(ActionEvent e ){
		...
		//for Number Button
		if(btn7 == e.getSource() || btn8 == e.getSource() ||btn9 == e.getSource() || btn4 == e.getSource() ||btn5 == e.getSource() ||btn6 == e.getSource() ||btn1 == e.getSource() ||btn2 == e.getSource() ||
		   btn3 == e.getSource() || btn0 == e.getSource() ||btndot == e.getSource() ){
			System.out.println("Number Clicked");
			screen.setText(screen.getText()+command);  //screen e text er sathe conmmand?(getactioncommand add korlam)
		}
		
		//for Operator Button
		else if(btndivide == e.getSource() ||btnplus == e.getSource() || btnminus == e.getSource() ||btnmulti == e.getSource()){
			System.out.println("Operator Clicked");
			num1 = Double.parseDouble(screen.getText()); //+-* pawar por etai screen er number(1,2,3)nia num1 e double akare rakbo
			screen.setText("");                          //new screen banabo jate ager ta run hoy
			//screen.setText(screen.getText()+command);
			operator = command;                         //+- ka operator nisabe nilam
			
			
		}
		
		else if(btneq == e.getSource()){                   //= pawar por jok kre dibo
			num2 = Double.parseDouble(screen.getText());   //num 1 e settext null korci,tai = chinnar somoy screen e num2 thakbe
			if(operator == "+"){
				result = num1 + num2;}
				...
				result = num1 * num2;}
				    ...
				    try{
					   ...
					   System.out.println("ArithmeticException found"); //---------------------ArithmeticException found-------------------------------
					   screen.setText(" Division by zero paichi");
                        return;}	
				}
